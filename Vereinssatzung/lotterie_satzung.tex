...
\item Sitz des Vereins ist Hamburg.
\item Geschäftsjahr des Vereins ist das Kalenderjahr. Das erste Rumpfjahr endet am 31. Dezember 2018.
\end{enumerate}

\item \textsf{\textbf{Zweck}}
\begin{enumerate}
\item Zweck des Vereins ist die Ausübung und Förderung des Tischfußballsports. Er veranstaltet hierzu Trainingstage, Tischfußballturniere, nimmt an Ligawettkämpfen teil und führt alle ihm zur Erreichung des Vereinszwecks geeignet erscheinenden Maßnahmen durch.
\end{enumerate}
